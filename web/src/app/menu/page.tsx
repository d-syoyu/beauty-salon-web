...
const menuCategories = [
  {
    ...
    items: [
      ...
      { name: '前髪カット + 顔まわり', price: '¥2,200' },
      { name: '毛量調整', price: '¥2,200' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'オーガニックカラー', price: '¥9,900' },
      { name: 'イルミナカラー', price: '¥11,000' },
      { name: 'アディクシーカラー', price: '¥11,000' },
      { name: 'ハイライト', price: '¥5,500〜' },
      { name: 'ローライト', price: '¥5,500〜' },
      { name: 'バレイヤージュ', price: '¥16,500〜' },
      { name: 'グラデーションカラー', price: '¥11,000〜' },
      { name: 'インナーカラー', price: '¥5,500〜' },
      { name: 'イヤリングカラー', price: '¥4,400〜' },
      { name: 'フェイスフレーミング', price: '¥6,600〜' },
      { name: 'ブリーチ（1回）', price: '¥8,800' },
      { name: 'ダブルカラー', price: '¥17,600〜' },
      { name: 'トリプルカラー', price: '¥24,200〜' },
      { name: 'グレイカラー（白髪染め）', price: '¥7,700' },
      { name: '白髪ぼかしハイライト', price: '¥13,200〜' },
      { name: 'グレイカラー + ハイライト', price: '¥15,400〜' },
    ]
  },
  {
    id: 'perm',
    ...
    items: [
      ...
      { name: 'エアウェーブ', price: '¥14,300' },
      { name: 'クリープパーマ', price: '¥12,100' },
      { name: '低温デジタルパーマ', price: '¥14,300' },
      { name: '毛先ワンカールパーマ', price: '¥9,900' },
      { name: 'ボリュームアップパーマ', price: '¥11,000' },
      { name: 'ゆるふわパーマ', price: '¥12,100' },
      { name: '韓国風パーマ', price: '¥13,200' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '縮毛矯正（ロング料金）', price: '¥19,800〜' },
      { name: 'ポイント縮毛矯正（前髪）', price: '¥5,500' },
      { name: 'ポイント縮毛矯正（顔まわり）', price: '¥8,800' },
      { name: 'ストレートパーマ', price: '¥11,000' },
      { name: 'ナチュラルストレート', price: '¥14,300' },
      { name: '酸性ストレート', price: '¥22,000' },
      { name: '縮毛矯正 + 毛先カール', price: '¥24,200' },
    ]
  },
  {
    id: 'hair-improvement',
    ...
    items: [
      ...
      { name: '髪質改善ストレート', price: '¥19,800' },
      { name: '酸熱トリートメント', price: '¥16,500' },
      { name: 'サイエンスアクア', price: '¥14,300' },
      { name: 'TOKIO インカラミ', price: '¥8,800' },
      { name: 'オージュア トリートメント', price: '¥7,700〜' },
      { name: 'ハホニコトリートメント', price: '¥6,600' },
      { name: 'オラプレックス', price: '¥3,300〜' },
      { name: 'ウルトワトリートメント', price: '¥13,200' },
      { name: '美髪チャージ', price: '¥5,500' },
    ]
  },
  {
    id: 'treatment',
    ...
    items: [
      ...
      { name: 'プレックス系トリートメント', price: '¥2,200〜' },
      { name: '艶髪トリートメント', price: '¥7,700' },
    ]
  },
  {
    id: 'spa',
    ...
    items: [
      ...
      { name: '炭酸ヘッドスパ', price: '¥3,300' },
      { name: 'アロマヘッドスパ', price: '¥5,500' },
      { name: '頭皮デトックススパ', price: '¥7,700' },
      { name: 'エイジングケアスパ', price: '¥8,800' },
    ]
  },
  {
    id: 'arrangement',
    ...
    items: [
      ...
      { name: 'ヘアセット（ハーフアップ）', price: '¥4,400' },
      { name: 'ヘアセット（編みおろし）', price: '¥6,600' },
      { name: '着付け + ヘアセット', price: '¥16,500〜' },
      { name: 'ブライダルヘアメイク', price: '¥33,000〜' },
      { name: 'ブライダルリハーサル', price: '¥11,000' },
      { name: '成人式ヘアセット', price: '¥8,800' },
      { name: '卒業式ヘアセット（袴）', price: '¥6,600' },
    ]
  },
  {
    id: 'set-menu',
    ...
    items: [
      ...
      { name: 'カット + 縮毛矯正', price: '¥20,900' },
      { name: 'カット + 髪質改善', price: '¥14,300' },
      { name: 'カット + カラー + トリートメント', price: '¥15,400' },
      { name: 'カット + カラー + パーマ', price: '¥18,700' },
      { name: 'カット + カラー + 髪質改善', price: '¥20,900' },
      { name: 'カラー + 髪質改善', price: '¥17,600' },
      { name: '縮毛矯正 + カラー', price: '¥24,200' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'ヘアミルク', price: '¥2,530〜' },
      { name: 'アウトバストリートメント', price: '¥3,080〜' },
